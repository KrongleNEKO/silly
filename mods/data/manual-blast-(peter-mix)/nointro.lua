...
-- [ IMPORTANT STUFF ] --
local shakeIntensity = 2 -- THE AMMOUNT OF MAX FROM 0, TO THIS VALUE ON WHAT THE STRUMS WILL MOVE (X, Y)
local shakeTime = 0.04 -- THE DELAY BTWN EACH SHAKE
...
function onUpdatePost(elapsed)
    if curStep <= 2292 and enabled then
